                ...
                <div class="wrapper_contentSide">
                    ...
                    <form action="" class="" id="signFace_form" method="POST">
                        <div class="signFace">
                            ...
                            <!-- User Email -->
                            <div class="userEmail">
                                <input type="email" name="user_email" class="input" id="user_email"
                            ...
                            <!-- User Phone -->
                            <div class="userPhone">
                                <input type="text" name="user_phone" class="input" id="user_phone" maxlength="12"
                                    oninvalid="this.setCustomValidity('ادخل رقم الهاتف')" placeholder="رقم الهاتف" />
                                <span class="d-none" id="num_vaild">ادخل رقم الهاتف</span>
                            </div>

                            <!-- User Password -->
                            <div class="userPassword">
                                <input type="password" name="user_password" class="input" id="user_password"
                    ...
                    <form action="" class="d-none" id="loginFace_form" method="POST">
                        <div class="loginFace">
                            ...
                            <div class="userEmailLogin">
                                <input type="email" name="user_email_login" class="input" id="user_email_login"
                                    placeholder="عنوان البريد الالكترونى" />
