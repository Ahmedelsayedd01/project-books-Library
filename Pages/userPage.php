      ...
      <section class="content_main">
        ...
        <div class="books" id="Books_list">
          ...
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">5653</span>
            </div>
          </a>
          <!-- ################# -->
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">3242</span>
            </div>
          </a>
          <!-- ################# -->
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">3223</span>
            </div>
          </a>
          <!-- ################# -->
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">1232</span>
            </div>
          </a>
          <!-- ################# -->
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">54654</span>
            </div>
          </a>
          <!-- ################# -->
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">4564</span>
            </div>
          </a>
          <!-- ################# -->
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">32432</span>
            </div>
          </a>
          <!-- ################# -->
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">7895</span>
            </div>
          </a>
          <!-- ################# -->
          <a href="./bookPage.html" target="_blank">
            ...
            <div class="overlay">
              <i class="fa-solid fa-eye"></i>
              <span class="count_view">45677</span>
            </div>
          </a>
          <!-- ################# -->
        </div>
